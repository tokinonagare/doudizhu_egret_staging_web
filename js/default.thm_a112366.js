window.skins={};
	...
	function DDZPlayerUI() {
		_super.call(this);
		this.skinParts = ["waitPlayerJoinRect","avatarImg","landlordHatImage","avatarGroup","nameLabel","scoreLabel"];
	...
	_proto.avatarGroup_i = function () {
		...
		t.x = 23;
		t.y = 8;
		t.elementsContent = [this.waitPlayerJoinRect_i(),this.avatarImg_i(),this.landlordHatImage_i()];
		return t;
	};
	_proto.waitPlayerJoinRect_i = function () {
		var t = new eui.Rect();
		this.waitPlayerJoinRect = t;
		t.fillColor = 0xffffff;
		t.height = 118;
		t.horizontalCenter = 0;
		t.top = 0;
	...
	var DDZPlayGameSceneUI$Skin24 = 	(function (_super) {
		__extends(DDZPlayGameSceneUI$Skin24, _super);
		function DDZPlayGameSceneUI$Skin24() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
			...
			this.states = [
				...
				new eui.State ("down",
					[
						new eui.SetProperty("_Image1","source","btn_room_invite_1@2x_png")
					])
				,
				new eui.State ("disabled",
					[
		...
		var _proto = DDZPlayGameSceneUI$Skin24.prototype;

		_proto._Image1_i = function () {
			var t = new eui.Image();
			this._Image1 = t;
			t.percentHeight = 100;
			t.source = "btn_room_invite_0@2x_png";
			t.percentWidth = 100;
			return t;
		};
		_proto.labelDisplay_i = function () {
	...
	_proto.roomDescriptionGroup_i = function () {
		var t = new eui.Group();
		this.roomDescriptionGroup = t;
		t.bottom = 526;
		t.height = 104;
		t.horizontalCenter = 0;
		t.width = 350;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this.clubNameLabel_i(),this.roomLabel_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto.inviteFriendGroup_i = function () {
		var t = new eui.Group();
		this.inviteFriendGroup = t;
		t.bottom = 340;
		t.height = 200;
		t.horizontalCenter = 0;
		t.width = 250;
		t.layout = this._VerticalLayout2_i();
		t.elementsContent = [this.inviteFriendTitleLabel_i(),this.inviteFriendButton_i()];
		return t;
	};
	_proto._VerticalLayout2_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto.inviteFriendTitleLabel_i = function () {
		var t = new eui.Label();
		this.inviteFriendTitleLabel = t;
		t.size = 28;
		t.text = "还差2人开始游戏";
		t.textColor = 0xfff1c1;
		t.x = 78;
		t.y = 18;
		return t;
	};
	_proto.inviteFriendButton_i = function () {
		...
		t.x = 102;
		t.y = 53;
		t.skinName = DDZPlayGameSceneUI$Skin24;
		return t;
	};
	...
	var DDZUserInfoAvatarUI$Skin25 = 	(function (_super) {
		__extends(DDZUserInfoAvatarUI$Skin25, _super);
		function DDZUserInfoAvatarUI$Skin25() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = DDZUserInfoAvatarUI$Skin25.prototype;
		...
		return DDZUserInfoAvatarUI$Skin25;
	})(eui.Skin);
	...
	_proto.avatarButton_i = function () {
		...
		t.verticalCenter = 0;
		t.percentWidth = 100;
		t.skinName = DDZUserInfoAvatarUI$Skin25;
		return t;
	};
	...
	var DDZUserInfoNameInputUI$Skin26 = 	(function (_super) {
		__extends(DDZUserInfoNameInputUI$Skin26, _super);
		function DDZUserInfoNameInputUI$Skin26() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = DDZUserInfoNameInputUI$Skin26.prototype;
		...
		return DDZUserInfoNameInputUI$Skin26;
	})(eui.Skin);
	...
	_proto.cleanButton_i = function () {
		...
		t.right = 10;
		t.verticalCenter = 0;
		t.skinName = DDZUserInfoNameInputUI$Skin26;
		return t;
	};
	...
	var DDZUserInfoPopupUI$Skin28 = 	(function (_super) {
		__extends(DDZUserInfoPopupUI$Skin28, _super);
		function DDZUserInfoPopupUI$Skin28() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = DDZUserInfoPopupUI$Skin28.prototype;
		...
		return DDZUserInfoPopupUI$Skin28;
	})(eui.Skin);

	function DDZUserInfoPopupUI() {
		_super.call(this);
		this.skinParts = ["userAvatar","nameLabel","editUsernameButton","idLabel","bindPhoneButton","basicInfoGroup","totalGame","winningRate","escapeRate","winningAmount","continueWinningAmount","userDataGroup","closeButton"];
	...
	_proto._Group1_i = function () {
		...
		t.percentWidth = 100;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.nameLabel_i(),this.editUsernameButton_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.bindPhoneButton_i = function () {
		...
		t.skinName = DDZUserInfoPopupUI$Skin28;
		return t;
	};
