window.skins={};
	...
	function DDZPlayGameTopToolbarUI() {
		_super.call(this);
		this.skinParts = ["widthLabel","heightLabel","closeButton","downloadLaiwanButton"];
		
		this.height = 150;
		this.width = 400;
		this.elementsContent = [this.widthLabel_i(),this.heightLabel_i(),this.closeButton_i(),this.downloadLaiwanButton_i()];
	}
	var _proto = DDZPlayGameTopToolbarUI.prototype;

	_proto.widthLabel_i = function () {
		var t = new eui.Label();
		this.widthLabel = t;
		t.text = "";
		t.x = 200;
